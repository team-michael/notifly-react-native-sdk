...
## [4.2.1-beta.1] - 2026-06-17

### Fixed

- Bump iOS SDK to 2.6.1-beta.1: recover from stale FCM registration tokens by deleting and refreshing the token, with compact refresh diagnostics.
