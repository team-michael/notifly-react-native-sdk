...
function EventPage({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ 'flexDirection': 'row', justifyContent: 'center', marginTop: '5%', marginHorizontal: '3%' }}>
                ...
                <View style={{ width: '40%', justifyContent: 'center', marginHorizontal: '3%' }}>
            ...
            <Button
                ...
                color="#841584"
            />
            <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Current Event Params</Text>
            {Object.keys(eventParams).map((key) => (
                <Text key={key} style={{ marginVertical: '1%', fontSize: 10 }}>
                    {key}: {eventParams[key]}
                </Text>
            ))}
            <Text style={{ marginTop: '10%', fontSize: 20, fontWeight: 'bold' }}>SegmentationEventParamKeys</Text>
            <TextInput
                style={styles.input}
                value={segmentationEventParamKeys}
                onChangeText={(text) => setSegmentationEventParamKeys([text == '' ? undefined : text])}
            />
